...
copy rankings from '/usr/local/bin/ruby_projects/database_projects/optimizer_practice/usnews.data' delimiters ',' with NULL '*';
copy financials from '/usr/local/bin/ruby_projects/database_projects/optimizer_practice/aaup.data' delimiters ',' with NULL '*';
copy students from '/usr/local/bin/ruby_projects/database_projects/optimizer_practice/students.dat' delimiters ',';
